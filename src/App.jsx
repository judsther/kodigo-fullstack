...
function App() {
 ...
 const cambiarTexto = () => {
  ...
  return (
    <>
      <body className="bg-gradient-to-br from-purple-700 via-indigo-500 to-blue-500 min-h-screen flex flex-col items-center justify-center text-white font-sans">
